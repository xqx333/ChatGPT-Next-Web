...
export function Settings() {
  ...
  const customModelAccess = useMemo(() => {
    const provider = getServiceProviderForRequestFormat(
      accessStore.requestFormat,
    );
    const isGeminiRequest = accessStore.requestFormat === RequestFormat.Gemini;
    const isAnthropicRequest =
      accessStore.requestFormat === RequestFormat.Anthropic;

    return {
      endpoint: isGeminiRequest
        ? accessStore.googleUrl
        : isAnthropicRequest
        ? accessStore.anthropicUrl
        : accessStore.openaiUrl,
      apiKey: isGeminiRequest
